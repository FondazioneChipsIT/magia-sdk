...
#define ONNX_ELU_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_ELU_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_elu_params_t))

#define INPUT_BASE  ALIGN_4B(ONNX_ELU_PARAMS_BASE + ONNX_ELU_PARAMS_SIZE)
